...
@section('extrajs')
<script>
    var searchroute = '{!! route('shib.tickets.search') .'/query/' !!}';
    {{-- var locale = '{{ asset("/i18n/$auth_user->locale.json") }}'; --}}
    var locale = 'en';
</script>
<script src="{{ asset('/js/shibtickets.index.js') }}"></script>
@stop
...
<div class="row">
    <div class="col-md-4 col-md-offset-8 text-right">
        {!! link_to_route('shib.tickets.export', trans('misc.button.csv_export'), ['format' => 'csv'], ['class' => 'btn btn-info']) !!}
    </div>
</div>
