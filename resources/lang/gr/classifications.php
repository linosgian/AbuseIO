...
return [
    ...
    'BOTNET_CONTROLLER' => [
        ...
        'GEANT_REPORTED' => [
        'name'        => 'Γενικό μήνυμα κατάχρησης',
        'description' => '
            <h2> Γιατί παίρνω αυτή την αναφορά? </h2>
            <p> Η αναφορά αυτή σας προωθείται όπως μας έχει σταλεί απο το <a href="http://www.geant.org/Networks/Network_Operations/Pages/GEANT_CERT.aspx">CERT του GEANT</a>
            Δυστυχώς δεν έχουμε επιπλέον πληροφορίες πέρα απο ότι αναγράφεται στις πληροφορίες του δελτίου αυτού.</p>
        ',
    ],
    ...
    'UNWANTED_SOFTWARE' => [
        ...
        'description' => '
            <h2> Ανεπιθύμητο Λογισμικό </h2>
            Λάβαμε αναφορά για ανεπιθύμητο λογισμικό που φιλοξενείται στην IP διεύθυνση / Domain name σας.
            ',
    ],
    ...
    'MALICIOUS_SOFTWARE' => [
        ...
        'description' => '
            <h2> Κακόβουλο Λογισμικό </h2>
            Λάβαμε αναφορά για κακόβουλο λογισμικό που φιλοξενείται στην IP διεύθυνση / Domain name σας.
            ',
    ],
